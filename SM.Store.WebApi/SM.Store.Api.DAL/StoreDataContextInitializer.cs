...
namespace SM.Store.Api.DAL
{
    public class StoreDataContextInitializer : DropCreateDatabaseIfModelChanges<StoreDataContext>
    {
        protected override void Seed(StoreDataContext context)
        {
            ...
            {
                new Contact { ContactID = 1, ContactName = "My Contact", Phone = "222-333-4444", Email = "demo@smstore.com", PrimaryType = 2, AuditTime = Convert.ToDateTime("2015-05-28")},
                new Contact { ContactID = 2, ContactName = "John Wood", Phone = "410-565-3879", Email = "johnwoo@retob.com", PrimaryType = 1, AuditTime = Convert.ToDateTime("2015-05-14")},
                new Contact { ContactID = 3, ContactName = "Dean Sapez", Phone = "647-596-2143", Email = "deans@fashep.com", PrimaryType = 2, AuditTime = Convert.ToDateTime("2015-06-27")}
            };
